...
function buildOutput(enable, module) {
    ...
    return {
        debug: root.console.debug.bind(
            root.console,
            consoleStyles.label.debug.text + "%s",
            consoleStyles.label.debug.style,
            consoleStyles.pathStyle,
            consoleStyles.normalStyle,
        ),
        info: root.console.info.bind(
            root.console,
            consoleStyles.label.info.text + "%s",
            consoleStyles.label.info.style,
            consoleStyles.pathStyle,
            consoleStyles.normalStyle,
        ),
        warn: root.console.warn.bind(
            root.console,
            consoleStyles.label.warn.text + "%s",
            consoleStyles.label.warn.style,
            consoleStyles.pathStyle,
            consoleStyles.normalStyle,
        ),
        error: root.console.error.bind(
            root.console,
            consoleStyles.label.error.text + "%s",
